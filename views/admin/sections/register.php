...
<form id="ews-admin-register-license" method="post" class="register-activator">
    ...
    <div id="contact-details" class="group fieldsgroup contact-details">
        ...
        <div class="fields">
            <fieldset id="fieldset-email-address" class="input email-address">
                <label for="field-email-address">Correo electrónico</label>
                <input type="email" id="field-email-address" name="email_address" required>
            </fieldset>
            <fieldset id="fieldset-phone-number" class="input phone-number">
                <label for="field-phone-number">Número de teléfono</label>
                <input type="text" id="field-phone-number" name="phone_number" required>
            </fieldset>
        </div>
    </div>
    <div id="product-selectors" class="group fieldsgroup product-selectors">
        <div class="heading">
            <h3 class="title">Seleccionar Producto(s)</h2>
            <p class="desc">Puedes seleccionar mas de un producto, el sistema sugerira un precio de venta.</p>
        </div>
        <div class="fields">
            <fieldset id="fieldset-product-office" class="input product-office">
                <label for="field-product-office">
                    <img src="/assets/svg/office-white.svg" alt="Office">
            ...
            <fieldset id="fieldset-product-windows" class="input product-windows">
                <label for="field-product-windows">
                    <img src="/assets/svg/windows-white.svg" alt="windows">
    ...
    <div id="order-payment" class="group fieldsgroup order-payment">
        <div class="heading">
        ...
        <div class="fields separator">
            <fieldset id="fieldset-currency" class="input currency">
            ...
            <fieldset id="fieldset-payment" class="input payment">
                <label for="field-payment">Precio de venta</label>
                <input type="number" id="field-payment" name="total_payment" min="0" step="0.01" value="0.00" placeholder="0.00" required>
                <span class="currency-badge">PEN</span>
            </fieldset>
            <fieldset id="fieldset-expenditure" class="input expenditure">
                <label for="field-expenditure">Precio de compra</label>
                <input type="number" id="field-expenditure" name="total_expenditure" min="0" step="0.01" value="0.00" placeholder="0.00">
                <span class="currency-badge">PEN</span>
            </fieldset>
        </div>
        <div class="fields">
            <fieldset id="fieldset-payment-method" class="input payment-method">
                <label for="field-payment-method">Método de pago</label>
                <select name="payment_method" id="field-payment-method">
            ...
            <fieldset id="fieldset-payment-description" class="input payment-description">
                <label for="field-payment-description">Descripción del pago</label>
                <input type="text" id="field-payment-description" name="payment_description" placeholder="PD00001" required>
            </fieldset>
            <fieldset id="fieldset-limit-activation" class="input limit-activation">
                <label for="field-limit-activations">Limite de activaciones</label>
                <input type="number" id="field-limit-activations" name="limit_activations" min="1" max="10" value="10">
            </fieldset>
        </div>
    </div>
    <div class="oder-summary">
        <h3 class="title">
            <span class="icon material-icons">turned_in</span>
            <span>Resumen de la orden</span>
        </h3>
        <div class="products">
            <button id="order-product-office" data-product="office" type="button" class="item fadein hidden button-product">
            ...
            <button id="order-product-windows" data-product="windows" type="button" class="item fadein hidden button-product">
                <div class="item-details">
                    <div class="logo">
        ...
        <div id="order-details" class="details">
            <div id="card-subtotal" class="card-price subtotal">
                <div class="amount">
            ...
            <div id="card-discount" class="card-price discount">
                <div class="amount">
            ...
            <div id="card-total" class="card-price total">
                <div class="amount">
    ...
    <input id="field-total-discount" type="hidden" name="total_discount" value="0">
</form>